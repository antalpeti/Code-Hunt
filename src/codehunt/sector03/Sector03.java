...
public class Sector03 {
    ...
    /**
     * Sum every even * even or every odd * odd numbers. In case of
     * upperdBound is even or odd.
     * @param upperBound
     * @return
     */
    ...
    /**
     * Replace every character to underline character with a space.
     * Except the end of the word will be no space.
     * @param word
     * @return
     */
